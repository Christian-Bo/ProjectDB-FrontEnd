...
<header class="navbar nt-navbar">
  <div class="container d-flex align-items-center justify-content-between">
    <a class="navbar-brand fw-bold d-flex align-items-center gap-2">
      <i class="bi bi-currency-exchange"></i> NextTech — Finanzas
    </a>
    <div class="d-flex align-items-center gap-2">
      <span id="user-role" class="badge bg-secondary">FINANZAS</span>
...
<main class="container py-4 flex-grow-1">
  <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
    <h1 class="h3 mb-0 nt-title">FINANZAS • Dashboard</h1>
    <small class="text-body-secondary">Accesos a módulos financieros.</small>
  </div>
  ...
  <div class="row g-3">
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="cxp.jsp">
        <div class="card-body">
          <div class="d-flex align-items-center mb-2"><i class="bi bi-cash-stack fs-3 me-2"></i><h5 class="card-title mb-0 nt-title">Cuentas por Pagar</h5></div>
          <p class="card-text text-body-secondary small">Documentos y pagos.</p>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="cxc.jsp">
        <div class="card-body">
          <div class="d-flex align-items-center mb-2"><i class="bi bi-wallet2 fs-3 me-2"></i><h5 class="card-title mb-0 nt-title">Cuentas por Cobrar</h5></div>
          <p class="card-text text-body-secondary small">Cobros y cartera.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="compras.jsp">
        <div class="card-body">
          ...
          <p class="card-text text-body-secondary small">Base para conciliación.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="compras_pagos.jsp">
        <div class="card-body">
          <div class="d-flex align-items-center mb-2"><i class="bi bi-receipt fs-3 me-2"></i><h5 class="card-title mb-0 nt-title">Pagos de Compras</h5></div>
          <p class="card-text text-body-secondary small">Aplicaciones y conciliación.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="ventas.jsp">
        <div class="card-body">
          ...
          <p class="card-text text-body-secondary small">Ingresos y conciliación.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="proveedores.jsp">
        <div class="card-body">
          ...
          <p class="card-text text-body-secondary small">Datos y estados.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
      <a class="card nt-card text-decoration-none h-100" href="catalogos.jsp">
        <div class="card-body">
          ...
          <p class="card-text text-body-secondary small">Auxiliares contables.</p>
          <span class="badge bg-outline">Acceso</span>
        </div>
      </a>
    </div>
...
<script>
  (function(){try{var r=(Auth.role&&Auth.role())?String(Auth.role()).toUpperCase():'FINANZAS';document.getElementById('user-role').textContent=r;}catch(e){}})();
